...
?>
        ...
        <div class="content">
            ...
            <hr>
        <p>
        46620#4662 on Discord has created a tool which compiles a pack containing the latest Atmosphere and Hekate versions, and the common homebrew utilities, tools and payloads. Atmosphere 1.1.0 is compatible with Switch firmware 13.0.0 and below.
		<br>This archive should not be used without <a href="https://nh-server.github.io/switch-guide/">this guide</a>, or help from <a href="https://discord.gg/dQgV6ZG" target=”_blank”>this server</a>.
		<br>The archive is automatically updated when there is a new release of a tool or resource.
		<br>The archive should be extracted directly to the SD card, keeping folder structure intact.
        <p>All care is taken in the delivery of these files, but no warranty, express or implied, is attached to the use of this archive, nor for any damages resulting thereof.
		<br><a href="https://catalyst.46620.moe/nx/latest.zip">Here is the archive.</a> You will need a zip extractor to extract it.
