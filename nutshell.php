	...
	<div id="page-content-wrapper">
		...
		<div class="accordion" id="accordionOperations">
			...
			<div class="card">
				...
				<div class="card-body">
				At the moment, we <b>speculate</b> that using CFW functions on an emuNAND/emuMMC is safe, <i>if you use 90dns or never connect to the Internet</i> on your emuMMC. 90dns is a utility that blocks connections to Nintendo servers, which allows you to use your console without the console sending telemetry to Nintendo.
